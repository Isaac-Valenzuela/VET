...
const Login = () => {
    ...
    return (
        <>
            <ToastContainer/>            <div className="w-1/2 h-screen bg-[url('/public/images/pep.jpg')] 
            ...
            <div className="w-1/2 h-screen bg-white flex justify-center items-center">
                ...
                <div className="md:w-4/5 sm:w-full">
                    ...
                    <h1 className="text-3xl font-semibold mb-2 text-center uppercase  text-gray-500">Hola Chamo</h1>
                    <small className="text-gray-400 block my-4 text-sm">Welcome back! Pon las crendeciales chamo</small>
